...
import { i as isEmotionCssPropElementType, e as isStyledElementType, u as unwrapFromPotentialFragment, c as createSerializer$1, t as tickle } from './create-serializer-fe4dd36c.esm.js';
...
var wrappedEnzymeSerializer = {
  ...
  print: function print(enzymeWrapper, printer) {
    ...
    if (isShallow && enzymeWrapper.root() === enzymeWrapper) {
      ...
      if (isEmotionCssPropElementType(unrendered) || isStyledElementType(unrendered)) {
        return enzymeToJsonSerializer.print(unwrapFromPotentialFragment(enzymeWrapper), printer);
      }
    }
