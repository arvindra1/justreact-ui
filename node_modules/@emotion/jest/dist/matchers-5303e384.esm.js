...
import { g as getClassNamesFromNodes, a as getStylesFromClassNames, b as getStyleElements, d as getMediaRules, h as hasClassNames, f as findLast } from './create-serializer-fe4dd36c.esm.js';
...
function toHaveStyleRule(received, property, value, options) {
  ...
  var result = preparedRules.filter(function (rule) {
    return rule.type === 'rule' && hasClassNames(classNames, rule.props, target);
